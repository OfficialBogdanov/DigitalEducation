...
namespace DigitalEducation
{
    ...
    {
        private static UserProgressModel _currentProgress;
        ...
        public static IProgressRepository Repository
        {
            ...
            {
                if (_repository == null)
                    _repository = new UserProgressFileRepository();
                return _repository;
            }
        ...
        private static UserProgressModel CreateDefaultProgress()
        {
        ...
        public static void SaveLessonCompletion(string lessonId, string courseId, double timeSpentMinutes)
        {
            lock (_lock)
            {
                try
                {
                    ...
                    int totalLessonsInCourse = LessonRegistry.GetTotalLessonsInCourse(courseId);
        ...
        public static CourseProgress GetCourseProgress(string courseId)
        {
            lock (_lock)
            {
                ...
                {
                    int totalLessons = LessonRegistry.GetTotalLessonsInCourse(courseId);
        ...
        {
            var courseCounts = LessonRegistry.GetCourseLessonCounts();
