...
namespace DigitalEducation
{
    public class AppNavigationService
    {
        ...
        public AppNavigationService(MasterLayout mainLayout) : this(mainLayout, new DefaultPageFactory()) { }

        public AppNavigationService(MasterLayout mainLayout, IPageFactory pageFactory)
        {
