...
{
    public class ProgressStatisticsCalculator : IStatisticsCalculator
    {
        public void UpdateStatistics(UserProgressModel progress)
        {
        ...
        public void UpdateDaysInARow(UserProgressModel progress)
        {
        ...
        public void UpdateCourseProgress(UserProgressModel progress, string courseId, int totalLessonsInCourse)
        {
        ...
        public void EnsureCourseProgressExists(UserProgressModel progress, string courseId, int totalLessons)
        {
