...
{
    public class LessonOverlayController
    {
        private readonly string _lessonId;
        private readonly OverlayWindow _window;
        private LessonDataModel _currentLesson;
        ...
        private readonly Func<string, LessonDataModel> _lessonLoader;
        ...
        public LessonOverlayController(
            string lessonId,
            OverlayWindow window,
            Func<string, LessonDataModel> lessonLoader,
