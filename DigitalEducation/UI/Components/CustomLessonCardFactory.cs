...
{
    public class CustomLessonCardFactory : ILessonCardFactory
    {
        private readonly FrameworkElement _resourceParent;

        public CustomLessonCardFactory(FrameworkElement resourceParent)
        {
        ...
        private Button CreateStartButton(string text, Action onClick)
        {
            ...
            AppThemeManager.UpdateImageSource(icon, "Right");
