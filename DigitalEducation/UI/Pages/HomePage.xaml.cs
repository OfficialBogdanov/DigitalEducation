...
namespace DigitalEducation
{
    public partial class HomePage : UserControl, IPage
    {
        ...
        public HomePage()
        {
            ...
            UserProgressManager.ProgressChanged += OnProgressChanged;
        ...
        {
            var stats = UserProgressManager.GetStatistics();
        ...
        public void UpdateProgress()
        {
            Dispatcher.BeginInvoke(new Action(() =>
            {
                var filesProgress = UserProgressManager.GetCourseProgress("Files");
                var systemProgress = UserProgressManager.GetCourseProgress("System");
                var officeProgress = UserProgressManager.GetCourseProgress("Office");
                var internetProgress = UserProgressManager.GetCourseProgress("Internet");
